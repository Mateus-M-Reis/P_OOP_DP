...
class Topic:
    ...
    def notifyAll(self, *args, **kwargs):
        for client in self.__clients:
            if kwargs.get('menOnly') and isinstance(client, ManAbove40):
...
for i in range(10):
    Subscribers.append(ManAbove40(topic))

for i in range(10):
    Subscribers.append(LadiesAbove30(topic))

topic.notifyAll('Thankyou for watching this video, please leave a like and subscribe!', menOnly=True)
